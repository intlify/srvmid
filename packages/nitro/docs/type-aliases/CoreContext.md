...
[@intlify/nitro](../index.md) / CoreContext
...
| `Locales`         | `IsNever`\<`ResourceLocales`\> _extends_ `true` ? `LocaleType` _extends_ `LocaleDetector` \| `Locale` ? `LocaleType` : `Locale` : `ResourceLocales`               |
