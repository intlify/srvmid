...
| [intlify](functions/intlify.md)                                                           | Internationalization plugin for Elysia          |
...
| -------------------------------------------------------- | ------------------------------------------------------------------- |
| [DefineLocaleMessage](interfaces/DefineLocaleMessage.md) | The type definition of Locale Message for `@intlify/elysia` package |
